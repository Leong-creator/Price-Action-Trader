...
当前默认下一步不是继续 broker/live，也不是自动扩更多标的或更长窗口，而是进入 `M10.11 Wave B Capital Backtest`，只测试 M10.10 queue 中的策略；继续停留在 `paper / simulated`。
