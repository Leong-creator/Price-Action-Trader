...
当前默认下一步不是继续 broker/live，也不是自动扩更多标的或更长窗口，而是进入 `M10.12 All Strategy Scorecard`，把 Wave A、Wave B、supporting、research-only 和暂不继续策略汇总成最终甲方矩阵；继续停留在 `paper / simulated`。
