...
当前默认下一步不是继续 broker/live，也不是自动扩更多标的或更长窗口，而是进入 `M11 Paper Gate`，基于 M10.13 runbook 准备 paper trading gate 报告；它只做准入评估，不批准 paper trading。
