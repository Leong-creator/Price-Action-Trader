...
class LocalPostcloseSchedulerTest(unittest.TestCase):
    ...
    def test_startup_script_only_references_m15_and_local_postclose_scheduler(self) -> None:
        ...
        self.assertIn("--config config/examples/m15_longbridge_sdk_runtime.json", script)
        self.assertIn("--config config/examples/m15_background_watchdog.json", script)
        self.assertNotIn("m15_longbridge_sdk_runtime.contract_v1.json", script)
        self.assertNotIn("m15_background_watchdog.contract_v1.json", script)
