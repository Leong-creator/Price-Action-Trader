...
class ContractV1RolloutTest(unittest.TestCase):
    ...
    def fixture(self, root: Path) -> tuple[Path, Path]:
        ...
        config = {
            ...
            "runtime": {"market_data_transport": "official_sdk_persistent_websocket", "sdk_subscribe_batch_size": 1, "heartbeat_interval_seconds": 5, "subscription_deadline_seconds": 20, "market_data_stall_seconds": 30, "account_snapshot_interval_seconds": 15, "account_snapshot_refresh_deadline_seconds": 8, "account_snapshot_circuit_retry_seconds": 15, "maximum_account_snapshot_age_seconds": 45, "complete_session_gate_enabled": True, "required_complete_sessions": 1, "paper_trading_only": True, "live_execution": False, "real_money_actions": False},
