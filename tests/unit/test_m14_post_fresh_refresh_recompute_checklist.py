...
class M14PostFreshRefreshRecomputeChecklistTest(unittest.TestCase):
    def test_builds_safe_recompute_checklist(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(result["summary"]["recompute_step_count"], 22)
            self.assertEqual(result["summary"]["m14_script_step_count"], 21)
            ...
            self.assertIn("M14 read-only script steps: `21`", md)
