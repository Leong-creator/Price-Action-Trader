...
from scripts.m15_quote_transport_canary_lib import load_symbols, run_cli_serve_canary, run_sdk_canary
...
def main() -> int:
    ...
    parser.add_argument("--transport", choices=("sdk", "cli-serve"), required=True)
