...
from m14_rescue_parameter_shadow_spec_lib import (
    DEFAULT_CONFIG_PATH,
    load_config,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build M14 rescue parameter shadow specifications.")
    ...
    payload = run_m14_rescue_parameter_shadow_spec(
