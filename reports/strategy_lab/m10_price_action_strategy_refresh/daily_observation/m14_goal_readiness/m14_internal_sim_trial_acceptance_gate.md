...
- Generated at: `2026-05-26T20:09:21Z`
...
- `waiting` `post_fresh_recompute_gate`: checklist steps=29; acceptance gates=9; two_pass_required=True. Pass: Rerun M14 read-only recompute sequence and then refresh project stage assessment. Fail: Do not declare objective complete until recompute artifacts are refreshed.
