...
- Generated at: `2026-05-26T20:00:00Z`
...
- Allowed now: `0`
- Blocked until fresh refresh: `10`
- Shadow runtime wait first ledger: `2`
...
- Priority: `P0`
- Issue: `zero_signal_after_connection` / `stale_quote_source_blocks_candidate`
- Status: `blocked_until_fresh_refresh`
- Allowed now: `False`
- Candidate parameter family: `quote_source_freshness_gate`
- Change scope: `source_quote_and_signal_count`
- Activation condition: Next M12.47-owned fresh Longbridge quote refresh clears fallback/stale source rows.
- Required evidence: Fresh quote source without fallback-only state.; Source-row and signal-count comparison before any detector or threshold change.; 10 rescue A/B trading days if a later parameter variant is created.
...
- Allowed now: `False`
- Candidate parameter family: `registry_input_signal_account_ledger_mapping`
- Change scope: `registry_to_signal_to_account_ledger`
- Activation condition: First M13 signal/account ledger row appears after a M12.47-owned fresh refresh.
- Required evidence: M12.47-owned fresh refresh, not manual M12.37 once-mode.; First rescue-specific M13 signal or account ledger row.; Then a full 10 rescue A/B trading-day evidence window before promote/modify/reject.
