...
- Generated at: `2026-05-26T23:20:00Z`
...
Variants:
- `fresh_quote_recheck_no_parameter_change` / `fresh_quote_recheck`: Recheck the existing rescue runtime with fresh Longbridge readonly quotes before changing any detector or threshold.
...
- State: `wait_first_ledger_before_parameter_decision`
- Gate state: `waiting_for_m12_47_fresh_refresh`
...
Variants:
- `ledger_mapping_audit_no_parameter_change` / `ledger_mapping_audit`: Audit registry, M12 account input, signal ledger, and account ledger mapping before any parameter decision.
